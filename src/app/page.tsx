...
const departments = [
  {
    title: "Deportes",
    description:
      "Organizamos y gestionamos todas las actividades deportivas: fútbol, básquet, tenis, ping pong, ajedrez, esports, natación y más. ¡Fomentamos el deporte en la comunidad ITBA!",
    icon: "⚽",
  },
  {
    title: "Náutica",
    description:
      "Gestionamos el barco del ITBA y todas las actividades relacionadas con la náutica, brindando una experiencia única para los estudiantes.",
    icon: "⛵",
  },
  {
    title: "Media",
    description:
      "Nos encargamos de la imagen del Centro y la comunicación efectiva con los alumnos, manteniendo a la comunidad informada y conectada.",
    icon: "📱",
  },
  {
    title: "IT",
    description:
      "Desarrollamos y mantenemos las soluciones tecnológicas del Centro, trabajando en proyectos informáticos para mejorar la experiencia estudiantil.",
    icon: "💻",
  },
  {
    title: "Infraestructura y Proyectos",
    description:
      "Gestionamos proyectos de mejora y mantenemos la infraestructura existente, trabajando constantemente para optimizar los espacios y recursos.",
    icon: "🔧",
  },
  {
    title: "Eventos y Cultura",
    description:
      "Organizamos eventos propuestos por alumnos y fomentamos actividades culturales, incluyendo intercambios de idiomas y otras iniciativas estudiantiles.",
    icon: "🎭",
  },
];
...
export default function Home() {
  ...
  return (
    <Layout activeTab={activeTab} onTabChange={setActiveTab}>
      ...
      <section
        id="hero"
        className={`select-none text-center mb-24 transition-all duration-1000 transform ${
      ...
      <section
        id="quick-access"
        className={`select-none mb-24 transition-all duration-1000 transform ${
      ...
      <section id="values" className={`select-none mb-24 max-w-5xl mx-auto`}>
        ...
        <div className="space-y-16">
          {values.map((value, index) => (
            <div
              key={index}
              className={`flex flex-col md:flex-row items-start gap-8 group transition-all duration-1000 transform ${
                isVisible("values")
      ...
      <section id="departments" className="mb-24 select-none max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {departments.map((dept, index) => (
            <div
              key={index}
              className={`group bg-surface hover:bg-surface/80 p-8 rounded-2xl transition-all duration-300 transform ${
