              ...
              <div className="mt-6">
                ...
                <div className="grid grid-cols-1 gap-6">
                  <AdminCard>
                    ...
                    />
                    <div className="divide-y divide-gray bg-background">
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center">
                                <div className="flex-shrink-0 h-10 w-10">
                                  <div className="h-10 w-10 rounded-full flex items-center justify-center text-primary">
                      ...
                      <AdminCardContent divider>
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                          ...
                          <div>
                            ...
                            <p className="mt-1 text-sm text-textDefault">
                              {selectedBenefit.max_capacity} personas
                            </p>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <p className="mt-1 text-sm text-textDefault">
                              {selectedBenefit.notes || <span className="text-gray-500">Sin notas</span>}
                            </p>
                          </div>
                        </div>
                      </AdminCardContent>
